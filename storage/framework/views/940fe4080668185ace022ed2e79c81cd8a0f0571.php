            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            ...
                            <div class="header-buttons">
                                <a href="<?php echo e(route($routes['show'],$entity)); ?>" title="<?php echo app('translator')->getFromJson('core::core.crud.back'); ?>" class="btn btn-primary btn-back btn-crud"><?php echo app('translator')->getFromJson('core::core.crud.back'); ?></a>
                            </div>
                            <div class="header-text">
                                <?php echo app('translator')->getFromJson($language_file.'.module'); ?>  - <?php echo app('translator')->getFromJson('core::core.crud.edit'); ?>
                    ...
                    <div class="body">
                        ...
                        <?php echo $__env->make('core::crud.module.edit_form', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
