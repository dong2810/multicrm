...
<head>
    ...
    <title> <?php echo e(\Modules\Platform\Core\Helper\SettingsHelper::getApplicationTitle()); ?></title>
    <!-- Favicon-->
    ...
    <?php echo $__env->make('partial.header_js', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<!-- Page Loader -->
<?php if(config('bap.preloader_type') != 'none'): ?>
    <div class="page-loader-wrapper">
        <div class="loader">

            <?php if(config('bap.preloader_type') == 'ball'): ?>
            ...
            <?php endif; ?>
                <?php if(config('bap.preloader_type') == 'circle'): ?>
            <div class="preloader">
...
<?php echo $__env->make('partial.search-bar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('partial.top-bar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<section>


    <?php echo $__env->make('partial.left-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    <?php echo $__env->make('partial.right-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</section>
...
<?php echo $__env->make('partial.bottom_js', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>


<?php echo $__env->yieldPushContent('scripts'); ?>
<script type="text/javascript" src="<?php echo e(asset('/bap/js/BapLazyDatatable.js')); ?>"></script>
...
<?php echo $__env->make('announcement::announcement-message', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
