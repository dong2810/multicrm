...
class ContactsController extends ModuleCrudController
{
    ...
    protected $relationTabs = [
        ...
        'events' => [
            ...
            'datatable' => [
                'datatable' => ContactEventsDatatable::class
            ],
            'route' => [
                'linked' => 'contacts.events.linked',
                'create' => 'calendar.events.create',
                'select' => 'contacts.events.selection',
                'bind_selected' => 'contacts.events.link'
            ],
            'create' => [
                'allow' => true,
                'modal_title' => 'calendar::events.create_new',
                'post_create_bind' => [
                    'relationType' => 'oneToMany',
                    'relatedField' => 'contact_id',
                ]
            ...
            'select' => [
                'allow' => false,
                'modal_title' => 'calendar::events.module'
            ],
        ],
    ...
    public function afterStore($request, &$entity)
    {
        ...
        // build SEO filename
        $filenameSeo='';
        if ( config('bap.gravatar_seo') ) {
            if ( config('bap.gravatar_seo_contact_name') ) {
                $filenameSeo .= $entity->full_name;
            }
            if ( '' != config('bap.gravatar_seo_contact_keywords') ) {
                $filenameSeo .= "_". config('bap.gravatar_seo_contact_keywords');
            }
    ...
    protected function setupIndexTabButtons()
    {
        $this->indexTabButtons[] = array(
            ...
            'attr' => [
                ...
                'role' => 'tab',
                'data-toggle'=>"tab",
                'onClick' => "BAP_Datatable.headerFilterReset('dataTableBuilder')"
            ],
        ...
        $this->indexTabButtons[] = array(
            ...
            'attr' => [
                ...
                'role' => 'tab',
                'data-toggle'=>"tab",
                'onClick' => "BAP_Datatable.headerFilterSet('assigned_to','dataTableBuilder',window.CURRENT_USER.name)"
            ],
