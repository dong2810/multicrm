...
Route::group(['middleware' => ['web', 'permission:contacts.browse'], 'prefix' => 'contacts', 'as' => 'contacts.', 'namespace' => 'Modules\Contacts\Http\Controllers'], function () {
    ...
    Route::get('contacts/events-selection/{entityId}', ['as'=>'events.selection','uses'=> 'Tabs\ContactEventsController@selection']);
    Route::get('contacts/events-linked/{entityId}', ['as'=>'events.linked','uses'=> 'Tabs\ContactEventsController@linked']);
    Route::post('contacts/events-unlink', ['as'=>'events.unlink','uses'=> 'Tabs\ContactEventsController@unlink']);
    Route::post('contacts/events-link', ['as'=>'events.link','uses'=> 'Tabs\ContactEventsController@link']);
    Route::post('contacts/events-delete', ['as'=>'events.delete','uses'=> 'Tabs\ContactEventsController@delete']);
