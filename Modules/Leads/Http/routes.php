...
Route::group(['middleware' => ['web','permission:leads.browse'],'prefix'=>'leads','as'=>'leads.', 'namespace' => 'Modules\Leads\Http\Controllers'], function () {
    ...
    Route::get('leads/events-selection/{entityId}', ['as'=>'events.selection','uses'=> 'Tabs\LeadEventsController@selection']);
    Route::get('leads/events-linked/{entityId}', ['as'=>'events.linked','uses'=> 'Tabs\LeadEventsController@linked']);
    Route::post('leads/events-unlink', ['as'=>'events.unlink','uses'=> 'Tabs\LeadEventsController@unlink']);
    Route::post('leads/events-link', ['as'=>'events.link','uses'=> 'Tabs\LeadEventsController@link']);
    Route::post('leads/events-delete', ['as'=>'events.delete','uses'=> 'Tabs\LeadEventsController@delete']);
